OpenStreetMap::Application.routes.draw do
  ...
  match 'api/0.6/changeset/:id' => 'changeset#read', :via => :get, :as => :changeset_read, :id => /\d+/, :defaults => { :format => :xml }
  match 'api/0.6/changeset/:id/subscribe' => 'changeset#subscribe', :via => :get, :as => :changeset_subscribe, :id => /\d+/ #ASK if it should go not via api
  match 'api/0.6/changeset/:id/unsubscribe' => 'changeset#unsubscribe', :via => :get, :as => :changeset_unsubscribe, :id => /\d+/
  ...
  match 'api/0.6/changeset/:id/comment' => 'changeset#comment', :via => :post
