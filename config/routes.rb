OpenStreetMap::Application.routes.draw do
  ...
  match 'api/0.6/changeset/:id/like' => 'changeset#like', :via => :post, :as => :changeset_like, :id => /\d+/
  match 'api/0.6/changeset/:id/unlike' => 'changeset#unlike', :via => :post, :as => :changeset_unlike, :id => /\d+/
