...
--
-- Name: changesets_likers; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE changesets_likers (
...
--
-- Name: changesets_likers_changeset_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY changesets_likers
    ADD CONSTRAINT changesets_likers_changeset_id_fkey FOREIGN KEY (changeset_id) REFERENCES changesets(id);


--
-- Name: changesets_likers_liker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY changesets_likers
    ADD CONSTRAINT changesets_likers_liker_id_fkey FOREIGN KEY (liker_id) REFERENCES users(id);
